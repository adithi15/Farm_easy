 <footer class="footer">
        <div class="container">
                ...
                <div class="col-4 col-md-2   align-self-center">				
                    <img class="align-text-center img-fluid"  src="assets/img/foot.png" />               
                </div>				
                <div class="offset-sm-2 col-5 ">
                    <h5>Our Address</h5>
                    <address>
		              Kharghar NaviMumbai -410210
                  Mahrahtra <br>		              
		              <div class="btn-group text-center" role="group">
                    <a role="button" class="btn btn-primary" href="tel:+918070185797"><i class="fa fa-phone"></i> Call</a>
                    <a role="button" class="btn btn-info" href="tel:+918070185797"> <i class="fa fa-fax"></i> Fax</a>
                    <a role="button" class="btn btn-success" href="mailto:yash@gmail.com"> <i class="fa fa-envelope-o"></i> Email</a>
                </div>
		           </address>
                </div>				
       ...
       <button target="_blank" href="/" rel="nofollow" class="btn btn-icon-only btn-linkedin rounded-circle" data-toggle="tooltip" data-original-title="Mail Us">
          ...
          <button target="_blank" href="/" rel="nofollow" class="btn btn-icon-only btn-github rounded-circle" data-toggle="tooltip" data-original-title="Star on Github">
           ...
           <div class="row justify-content-center">             
                     <div class="col-auto">					
                    <p>&copy; Copyright 2024 FARMEASY, All Rights Reserved 
                     
                    </p>
                </div>
                
                <p>  Made by team YASH </p>
           </div>
        </div>
    </footer>
