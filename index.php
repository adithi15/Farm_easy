...
<head>
  ...
  <link rel="icon" type="image/png" href="assets/img/feet.png" />
        ...
        <div class="container">
          <div class="row row-header">
            <div class="col-12 col-sm-6">
              <h1 class="text-white">FarmEasy</h1>
              <p class="text-white">
              Empowering Farmers with Weather Wisdom and Predictive Harvest Insights!
              </p>
              <div class="cg">
            ...
            <div class="col-12 col-sm-3 offset-sm-2 align-self-center">
              <img src="assets/img/v.png" class="img-fluid" alt="" />
            </div>
          </div>
        </div>
      </header>
      ...
      <div class="container ">
        ...
        <div class="row">
                <div class="col-md-8 mx-auto text-center">
                    <span class="badge badge-primary badge-pill mb-3">DETAILS</span>
                    <h3 class="display-3 ">ASPECTS</h3>
                </div>
            </div>
			<br>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-6">
           ...
           <p class=" ">  unlocks the power of Farming's Foresight.  We don't rely on crystal balls, but on cutting-edge data and insights.  This allows you to anticipate upcoming yields, plan your resources effectively, and even discover exciting new varieties on the horizon.</p>
          ...
          <div class="col-lg-6 col-10 mx-md-auto d-none d-md-block">
            <img class="ml-lg-5  pull-right" src="assets/img/bussiness.png" width="100%">
          </div>
        </div>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-6">
           ...
           <p class=" ">Our website offers a glimpse into the future of your fridge, providing insights on upcoming harvests and exciting new varieties. But that's not all! We connect you with the passionate farmers growing this future, allowing you to learn their stories and support sustainable practices. So, ditch the grocery store guessing game and visit us today to explore a world of fresh possibilities.</p>
          ...
          <div class="col-lg-6 col-10 mx-md-auto d-none d-md-block">
            <img class="ml-lg-5  pull-right" src="assets/img/aim.png" width="100%">
          </div>
        </div>
          ...
          <div class="col-lg-6">
           ...
           <p class=""> The driving force behind the sustainable farming movement, actively 
           seeking out farmers who share their values. By connecting directly with these 
           discerning diners, you're not just getting fresh, high-quality food, you're becoming
            part of a movement that's shaping a healthier future for our plates and our planet. ">
           </p>
          ...
          <div class="col-lg-6 col-10 mx-md-auto d-none d-md-block">
            <img class="ml-lg-5  pull-right" src="assets/img/customers.png" width="100%">
          </div>
        </div>
...
const apiKey = "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";   // Enter your apikey here
